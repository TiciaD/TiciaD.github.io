                    ...
                    <Card className="shadow p-4 mb-5 bg-body rounded">
                        <Card.Body>
                            ...
                            <Card.Text className="blog-post fw-normal">
                                ...
                                <br />
                                <br />
                                I'm definitely excited to get into programming languages now to get some powerful tools in my belt. That way I can start designing my blog to look as cool as I'm picturing in my head! It's so interesting to browse through portfolio examples from past students or even 
                                just on Google seeing different professionals and their websites and knowing I'm just a few months of being capable of emulating that is such an exciting feeling. I have a little experience with the Adobe Creative Suite and Figma and I'm really excited to learn how to integrate that with my new programming capabilities.
                                <br />
                                <br />
                                ...
                                <Button className={`mx-3 py-1 px-1 ${"collapsed" ? buttonText = "Read More" : buttonText = "Read Less"}`} type="button" data-bs-toggle="collapse" data-bs-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample">
                                    {buttonText}
                                </Button> */}
                            </Card.Text>
                        </Card.Body>
                    ...
                    <Card className="shadow p-4 mb-5 bg-body rounded">
                        <Card.Body>
                            ...
                            <Card.Text className="blog-post fw-normal">
                                ...
                                opens up with options or making a picture pop out when you hover over it.
                                <br />
                                <br />
                                Me and CSS right now have a love hate relationship going on. After learning HTML and getting somewhat confident with that, 
                                CSS has been a headache in comparison. I can see the potential in CSS but I feel like my limited toolset is keeping me handcuffed 
                                from truly implementing its full potential. I've been doing some supplemental learning from YouTube tutorials on Website Building 
                                and they've been very informative and inspiring. It's just tough for me right now to bridge that gap between how they were able to 
                                implement those features in  their work and how to implement those same features in my own.
                                <br />
                                <br />
                                When I encounter problems in my code, I tend to keep a level head. First, I look around for the common mistakes like missing semicolons, 
                                quotes, parentheses, etc. When I eliminate that, if it's an issue I've encountered before or I may have heard someone else encountered, 
                                I'll go to whatever techniques I used then or check our class group chat and follow through what they were told to do. If that all fails, 
                                then Google is my new best friend, and I try to describe the problem and see if it's been posted on StackOverflow or other forums where 
                                someone else potentially had the same problem. I usually have to take a break after looking this far and long into a problem, so I step 
                                away from the computer to give myself a mental break whenever it gets to be too much. Eventually with enough time, patience and research 
                                I'm able to figure out what I was missing so I try to avoid asking for help in the class group chat as much as I can so I can develop my 
                                research abilities. It'll be important for me to know how to solve these problems on my own but also know when to ask help if it's too 
                                far above my abilities.
                                <br />
                                <br />
                                I feel like I'm learning so much every single day and yet still feel like I've barely dipped my toe in a sea of coding knowledge. 
                                I guess that means I'm only inches from the dreaded Cliff of Confusion... 
                            </Card.Text>
                        </Card.Body>
                    </Card>
                </Col>
                    ...
                    <Card className="shadow p-4 mb-5 bg-body rounded">
                        <Card.Body>
                            ...
                            <Card.Text className="blog-post fw-normal">
                                ...
                                more guided modules that 'held your hand' with the new concepts. It took me several days to finish that one since I kept taking breaks every time I got 
                                frustrated, which was a lot...
                                <br />
                                <br />
                                I went ahead and started on the Build projects, the Silly Story generator was pretty straightforward and I didn't have many problems with it, but the Alarm Clock? 
                                I learned how to fail pretty quick with that one. In hindsight, I realize I probably should've used more pseudocode to make a plan of attack on how to approach the 
                                Alarm clock project. I guess it was slightly jarring to go from the guided instructions for the Silly Story generator that had about 70% of the work done for you. 
                                ...
                                Not to mention how advanced some of my other classmates' code looked! All I could think the whole time was, 'How on Earth did you figure out how to do that? AND still 
                                ...
                                with planning the alarm clock project, I'm going to be practicing it a lot over the weekend so I'm better prepared for the next Build.
                            </Card.Text>
                        </Card.Body>
                    </Card>
                </Col>
                    ...
                    <Card className="shadow p-4 mb-5 bg-body rounded">
                        <Card.Body>
                            ...
                            <Card.Text className="blog-post fw-normal">
                                ...
                                actual code. Since the Pseudocode project went well though, I've come to terms with the chaos of JavaScript. I understand I'm not going to have to do anything extravagant, 
                                it's more important to be able to look at the final code and be able to explain *how* it works for the most part. I still feel like I have a long way to go, but I'm a lot 
                                less anxious about not fully comprehending JavaScript yet.
                                <br />
                                <br />
                                During Onboarding I found a lot of the resources given to me super helpful. I like having multiple explanations of the same concept, especially some that are a little more 
                                complex. I just wished we had more lectures over some of the basics. I felt like there was a lot of reading the MDN and other articles and books but I personally feel like 
                                I learn better with actual lectures where I can actively see these concepts explained and applied. I did a lot of outside learning, specifically with Udemy watching video 
                                lectures from Colt Steele's Web Developer Bootcamp. He does a great job explaining JavaScript from scratch for total beginners, literally describing each concept in-depth 
                                like variables, for...of loops, while loops, functions, etc. They were super helpful, I feel like understanding these basics more in-depth helped me with my problem-solving 
                                since I now actually understand what these methods can do a lot better.
                            </Card.Text>
                        </Card.Body>
                    </Card>
                </Col>
