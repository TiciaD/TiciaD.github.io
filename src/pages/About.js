            ...
            <Container className="w-100 h-100 p-3 mx-auto mt-5 d-flex justify-content-center">
                <Row>
                    <Col className="intro px-5 pb-4 m-5 rounded text-center">
                        ...
                        <h1 className="p-3 title-name">About Me</h1>
                        ...
                        in Chemistry in 2020. Unfortunately, in my desperation to graduate, I settled on a major I wasn't passionate for just because I had more credits towards it. This resulted in me going into the workforce with a 
                        ...
                        coding, I still want to have time to enjoy some of my other hobbies, like art, playing with my pets and traveling to events all over the country!
                        </p>
                    </Col>
                </Row>
            </Container>
