            ...
            <Container className="w-100 h-100 p-3 mx-auto mt-5 d-flex justify-content-center">
                <Row>
                    <Col className="intro px-5 pb-4 m-5 rounded text-center">
                        ...
                        <p className="lead p-3">As I searched for career change options, Computer Science popped up over and over. I decided to look more into it and it seemed that it would satisfy everything that I was looking for in a career, 
                        ...
                        <p className="lead p-3">I can't wait to get back out in the workforce and become a real developer, applying everything I've learned so far and still learning something new everyday! As I've developed a new passion for 
